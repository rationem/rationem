...
public class AccountTypeBean extends BaseBean {
    ...
    private static final Logger logger =
            Logger.getLogger("accounts.beans.AccountType");
 ...
 public void onEditActTyMnu(){
  ...
  RequestContext rCtx = RequestContext.getCurrentInstance();
  rCtx.update("actTyEdFrmId");
  rCtx.execute("PF('editAcntGrpWvar').show();");
 }
 ...
 public void onActTypeUpdate(){
  ...
  selectedAcType = null;
  RequestContext rCtx = RequestContext.getCurrentInstance();
  rCtx.update("actTypeTbl");
  rCtx.execute("PF('editAcntGrpWvar').hide()");
 }
